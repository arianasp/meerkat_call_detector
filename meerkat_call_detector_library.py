# -*- coding: utf-8 -*-
"""meerkat_call_detector_library.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1pUeWqQiJemUwF1nWMTK0RZmoBE6X-_te
"""
...
def generate_sample_call(files, clips_dir, call_type = None):
    ...
    y = y.reshape((len(y),1))
    X = skimage.measure.block_reduce(X, (8,1), np.mean)
